...
# 프로젝트 루트를 Python path에 추가 (scripts/video/core에서 루트로)
...
def find_result_files(results_dir: str = "results"):
    ...
    if not os.path.isabs(results_dir):
        results_dir = os.path.join(str(project_root), results_dir)
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="output/videos/pipeline",
                       help="비디오 출력 디렉토리")
