...
# 프로젝트 루트 디렉토리 (scripts/experiments에서 루트로)
project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
os.chdir(project_root)

# Python path에 루트 디렉토리 추가
...
def main():
    ...
    experiments = [
        ...
        },
        {
            ...
            "command": "python scripts/video/core/render_learning_video.py --sample-data --learning-only --duration 10",
            "timeout": 180
        },
        {
            "name": "7. 비교 비디오 생성",
            "command": "python scripts/video/comparison/create_comparison_video.py --auto --episodes 50",
            "timeout": 300
        }
    ]
