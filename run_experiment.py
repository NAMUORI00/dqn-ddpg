...
def main():
    ...
    plot_learning_curves(
        ...
        save_path=f"{args.results_dir}/learning_curves.png"
    )
    ...
    visualize_deterministic_policy(
        ...
        save_path=f"{args.results_dir}/deterministic_policy_analysis.png"
    )
    ...
    plot_comparison_summary(
        dqn_eval, ddpg_eval,
        save_path=f"{args.results_dir}/final_comparison.png"
    )
